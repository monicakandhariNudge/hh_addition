        ...
        <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-5 rounded-2xl border-2 border-pink-200 shadow-sm hover:shadow-md transition-all">
          <div className="text-center mb-4">
            <div className="bg-white w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md border-2 border-pink-300">
              <img src={femaleGoatIcon} alt="Female Goat" className="w-16 h-16 sm:w-20 sm:h-20" />
            </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-5 rounded-2xl border-2 border-blue-200 shadow-sm hover:shadow-md transition-all">
          <div className="text-center mb-4">
            <div className="bg-white w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md border-2 border-blue-300">
              <img src={maleGoatIcon} alt="Male Goat" className="w-16 h-16 sm:w-20 sm:h-20" />
            </div>
          ...
          <div className="flex items-center justify-center space-x-4">
            <div className="flex items-center space-x-2">
              <div className="bg-white w-12 h-12 rounded-full flex items-center justify-center shadow-sm border-2 border-pink-200">
                <img src={femaleGoatIcon} alt="Female" className="w-8 h-8" />
              </div>
            ...
            <div className="flex items-center space-x-2">
              <div className="bg-white w-12 h-12 rounded-full flex items-center justify-center shadow-sm border-2 border-blue-200">
                <img src={maleGoatIcon} alt="Male" className="w-8 h-8" />
              </div>
    ...
    <div className="space-y-4">
      <div className="text-center mb-4">
        <div className="bg-gradient-to-br from-pink-100 to-pink-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
          <img src={femaleGoatIcon} alt="Female Goat" className="w-14 h-14" />
        </div>
    ...
    <div className="space-y-4">
      <div className="text-center mb-4">
        <div className="bg-gradient-to-br from-blue-100 to-blue-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-3 shadow-md">
          <img src={maleGoatIcon} alt="Male Goat" className="w-14 h-14" />
        </div>
